...
/**
 * Helper function to extract CSRF token from meta tag
 * Runs synchronously to avoid setState in useEffect
 */
...
export default function Home() {
  ...
  // We extract it here from the HTML page generated by the server
  // Extract at initialization time instead of in useEffect to avoid setState in effect
  const [csrfToken] = useState<string>(getCSRFTokenFromDOM())
