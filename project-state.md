...
- [x] **UX-004 — Perte de focus de l'input chat sur envoi (Enter)** `LOW`
  ...
  - Livré sur branche `ux-004-chat-input-focus` (1 commit `1b4040b`, locale, non poussée, non fusionnée, non déployée) — voir « Terminé ✅ → UI / UX »
